            ...
            children: [
              ...
              Text(
                valueOrDefault<String>(
                  (_model.apiResultyf9?.jsonBody ?? '').toString(),
                  '0',
                ),
              ...
              FFButtonWidget(
                onPressed: () async {
                  _model.apiResultyf9 = await RandomNumberCall.call();

                  if ((_model.apiResultyf9?.succeeded ?? true)) {
                    FFAppState().randomNum = FFAppState().randomNum;
                    safeSetState(() {});
                  }
